...
\subsection{Paste}
This function doesn't require any parameters to work. It takes whatever the system's clipboard has in store and makes it available inside Mars for later use.
\begin{lstlisting}
// Basic command call
$ mars paste
Clipboard contents pasted into Mars.
\end{lstlisting}
